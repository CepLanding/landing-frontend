  ...
  areasConvenios = [
    {
      ...
      convenios: [
        ...
        { nombre: 'FERGINEST', logoUrl: '/assets/img/convenios/logos/salud/ferginest.png', descripcion: 'FERGINEST.', enlaceEmpresa: 'https://www.instagram.com/ferginest.peru/', enlaceDrive: 'https://drive.google.com/drive/folders/1S3XsE29fYjOelGBconewMHhr9OZFvKp8?usp=drive_link' },
        ...
        { nombre: 'Centro Odontológico CEOR Larco SAC', logoUrl: '/assets/img/convenios/logos/salud/ceor.jpg', descripcion: 'Centro Odontológico CEOR Larco SAC.', enlaceEmpresa: 'https://ceorperu.com/', enlaceDrive: 'https://drive.google.com/drive/folders/1QjWN4xvnEhO7Xw-gF8DAyKYghqOSTUfm' },
    ...
    },
    {
      ...
      convenios: [
        ...
        { nombre: 'UCH', logoUrl: '/assets/img/convenios/logos/educacion/UCH.png', descripcion: 'Universidad de Ciencias y Humanidades', enlaceEmpresa: 'https://www.uch.edu.pe/', enlaceDrive: 'https://drive.google.com/drive/folders/1EDPXpfczx61b7OV1ioPmW6flaXHByyKx?usp=drive_link' },
        { nombre: 'UPAO', logoUrl: '/assets/img/convenios/logos/educacion/upao.png', descripcion: '', enlaceEmpresa: '', enlaceDrive: '' },
        { nombre: 'ALTUX', logoUrl: '/assets/img/convenios/logos/educacion/altux.png', descripcion: 'ALTUX', enlaceEmpresa: 'https://altux.pe/', enlaceDrive: 'https://drive.google.com/drive/folders/14UBFNJTfYf5eUkB9ctndNUfRT8JaSmjs' },        
        { nombre: 'UNIR', logoUrl: '/assets/img/convenios/logos/educacion/unir.png', descripcion: 'La Universidad en Internet.', enlaceEmpresa: 'https://peru.unir.net/', enlaceDrive: 'https://drive.google.com/drive/folders/1qlqaCazkHTly8eW9KtWsjX1r5TDLnwIz' },
        { nombre: 'EDESIP', logoUrl: '/assets/img/convenios/logos/educacion/EDESIP.png', descripcion: 'Escuela de Desarrollo e Innovación Profesional', enlaceEmpresa: 'https://virtual.edesip.edu.pe/', enlaceDrive: 'https://drive.google.com/drive/folders/1qJmnEoJXI4kW6q9K65nsG8WLaL5YCNB1' },
        { nombre: 'Gestiona SAC', logoUrl: '/assets/img/convenios/logos/educacion/gestionaperu_logo.jpg', descripcion: '', enlaceEmpresa: 'https://gestionaperu.com/', enlaceDrive: 'https://drive.google.com/drive/folders/1l2z6F4KwCACIOcvCOofT1IR9JrTIl6zO' },
    ...
    },
    {
      nombre: 'Gastronomía',
      convenios: [
        { nombre: 'Don Rulo', logoUrl: '/assets/img/convenios/logos/gastronomia/rulo.png', descripcion: '', enlaceEmpresa: 'https://www.donrulo.com/', enlaceDrive: '' },
        { nombre: 'La Esquina de Huanchaco', logoUrl: '/assets/img/convenios/logos/gastronomia/huanchaco.jpg', descripcion: '', enlaceEmpresa: 'https://www.instagram.com/laesquinahuanchaco/', enlaceDrive: '' },
        { nombre: 'La Morena de Oro', logoUrl: '/assets/img/convenios/logos/gastronomia/morena.jpg', descripcion: '', enlaceEmpresa: 'https://www.facebook.com/p/Cebicheria-Morena-De-ORO-100049007841792/', enlaceDrive: '' },
    ...
    // },
    {
      ...
      convenios: [
        ...
        { nombre: 'Montalvo', logoUrl: '/assets/img/convenios/logos/estetica/montalvo.jpg', descripcion: '', enlaceEmpresa: 'https://montalvo.edu.pe/', enlaceDrive: '' }
      ]
    },
    {
      nombre: 'Recreación',
      convenios: [
        ...
        { nombre: 'Viru Tours Travel', logoUrl: '/assets/img/convenios/logos/recreacion/viru.png', descripcion: '', enlaceEmpresa: 'https://virutourstravel.pe/', enlaceDrive: '' }
      ]
    },
    // {
    //   nombre: 'Deporte',
